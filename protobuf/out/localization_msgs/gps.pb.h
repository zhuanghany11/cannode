...
#ifndef GOOGLE_PROTOBUF_INCLUDED_localization_5fmsgs_2fgps_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_localization_5fmsgs_2fgps_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:control.localization.Gps) */ {
 public:
  ...
  Gps* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "control.localization.Gps"; }
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::control::localization::Pose* release_localization();
  ::control::localization::Pose* mutable_localization();
  void set_allocated_localization(::control::localization::Pose* value);
  void unsafe_arena_set_allocated_localization(::control::localization::Pose* value);
...
inline const ::control::common::Header& Gps::header() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:control.localization.Gps.header)
  return _internal_header();
}
inline void Gps::unsafe_arena_set_allocated_header(::control::common::Header* value) {
...
inline ::control::common::Header* Gps::mutable_header() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
  ::control::common::Header* _msg = _internal_mutable_header();
  // @@protoc_insertion_point(field_mutable:control.localization.Gps.header)
  return _msg;
}
inline void Gps::set_allocated_header(::control::common::Header* value) {
...
inline const ::control::localization::Pose& Gps::_internal_localization() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::control::localization::Pose* p = _impl_.localization_;
  return p != nullptr ? *p : reinterpret_cast<const ::control::localization::Pose&>(::control::localization::_Pose_default_instance_);
}
inline const ::control::localization::Pose& Gps::localization() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:control.localization.Gps.localization)
  return _internal_localization();
}
inline void Gps::unsafe_arena_set_allocated_localization(::control::localization::Pose* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.localization_);
  }
  _impl_.localization_ = reinterpret_cast<::control::localization::Pose*>(value);
  if (value != nullptr) {
...
inline ::control::localization::Pose* Gps::release_localization() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::control::localization::Pose* released = _impl_.localization_;
...
inline ::control::localization::Pose* Gps::unsafe_arena_release_localization() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::control::localization::Pose* temp = _impl_.localization_;
  _impl_.localization_ = nullptr;
  return temp;
}
inline ::control::localization::Pose* Gps::_internal_mutable_localization() {
  ...
  if (_impl_.localization_ == nullptr) {
    ...
    _impl_.localization_ = reinterpret_cast<::control::localization::Pose*>(p);
  }
  return _impl_.localization_;
}
inline ::control::localization::Pose* Gps::mutable_localization() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000002u;
  ::control::localization::Pose* _msg = _internal_mutable_localization();
  // @@protoc_insertion_point(field_mutable:control.localization.Gps.localization)
  return _msg;
}
inline void Gps::set_allocated_localization(::control::localization::Pose* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.localization_);
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_localization_5fmsgs_2fgps_2eproto_2epb_2eh
