...
static void InitDefaultsscc_info_PidConf_control_5fbase_2fpid_5fconf_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::control::_PidConf_default_instance_;
    new (ptr) ::control::PidConf();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::control::PidConf::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PidConf_control_5fbase_2fpid_5fconf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_PidConf_control_5fbase_2fpid_5fconf_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_control_5fbase_2fpid_5fconf_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_control_5fbase_2fpid_5fconf_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_control_5fbase_2fpid_5fconf_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_control_5fbase_2fpid_5fconf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::control::PidConf, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::control::PidConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::control::PidConf, integrator_enable_),
  PROTOBUF_FIELD_OFFSET(::control::PidConf, integrator_saturation_level_),
  PROTOBUF_FIELD_OFFSET(::control::PidConf, kp_),
  PROTOBUF_FIELD_OFFSET(::control::PidConf, ki_),
  PROTOBUF_FIELD_OFFSET(::control::PidConf, kd_),
  PROTOBUF_FIELD_OFFSET(::control::PidConf, kaw_),
  PROTOBUF_FIELD_OFFSET(::control::PidConf, output_saturation_level_),
  6,
  0,
  1,
  2,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 12, sizeof(::control::PidConf)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::control::_PidConf_default_instance_),
};

const char descriptor_table_protodef_control_5fbase_2fpid_5fconf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_control_5fbase_2fpid_5fconf_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_control_5fbase_2fpid_5fconf_2eproto_sccs[1] = {
  &scc_info_PidConf_control_5fbase_2fpid_5fconf_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_control_5fbase_2fpid_5fconf_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_control_5fbase_2fpid_5fconf_2eproto = {
  false, false, descriptor_table_protodef_control_5fbase_2fpid_5fconf_2eproto, "control_base/pid_conf.proto", 199,
  &descriptor_table_control_5fbase_2fpid_5fconf_2eproto_once, descriptor_table_control_5fbase_2fpid_5fconf_2eproto_sccs, descriptor_table_control_5fbase_2fpid_5fconf_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_control_5fbase_2fpid_5fconf_2eproto::offsets,
  file_level_metadata_control_5fbase_2fpid_5fconf_2eproto, 1, file_level_enum_descriptors_control_5fbase_2fpid_5fconf_2eproto, file_level_service_descriptors_control_5fbase_2fpid_5fconf_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_control_5fbase_2fpid_5fconf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_control_5fbase_2fpid_5fconf_2eproto)), true);
namespace control {
...
PidConf::PidConf(const PidConf& from)
  ...
  // @@protoc_insertion_point(copy_constructor:control.PidConf)
}
...
const PidConf& PidConf::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_PidConf_control_5fbase_2fpid_5fconf_2eproto.base);
...
// @@protoc_insertion_point(generalized_merge_from_start:control.PidConf)
  GOOGLE_DCHECK_NE(&from, this);
  const PidConf* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PidConf>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:control.PidConf)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:control.PidConf)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:control.PidConf)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::control::PidConf* Arena::CreateMaybeMessage< ::control::PidConf >(Arena* arena) {
  return Arena::CreateMessageInternal< ::control::PidConf >(arena);
}
