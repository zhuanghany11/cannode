...
static void InitDefaultsscc_info_MracConf_control_5fbase_2fmrac_5fconf_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::control::_MracConf_default_instance_;
    new (ptr) ::control::MracConf();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::control::MracConf::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MracConf_control_5fbase_2fmrac_5fconf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MracConf_control_5fbase_2fmrac_5fconf_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_control_5fbase_2fmrac_5fconf_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_control_5fbase_2fmrac_5fconf_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_control_5fbase_2fmrac_5fconf_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_control_5fbase_2fmrac_5fconf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::control::MracConf, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::control::MracConf, mrac_model_order_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, reference_time_constant_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, reference_natural_frequency_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, reference_damping_ratio_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, adaption_state_gain_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, adaption_desired_gain_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, adaption_nonlinear_gain_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, adaption_matrix_p_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, mrac_saturation_level_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, anti_windup_compensation_gain_),
  PROTOBUF_FIELD_OFFSET(::control::MracConf, clamping_time_constant_),
  6,
  0,
  1,
  2,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 16, sizeof(::control::MracConf)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::control::_MracConf_default_instance_),
};

const char descriptor_table_protodef_control_5fbase_2fmrac_5fconf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ant\030\013 \001(\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_control_5fbase_2fmrac_5fconf_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_control_5fbase_2fmrac_5fconf_2eproto_sccs[1] = {
  &scc_info_MracConf_control_5fbase_2fmrac_5fconf_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_control_5fbase_2fmrac_5fconf_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_control_5fbase_2fmrac_5fconf_2eproto = {
  false, false, descriptor_table_protodef_control_5fbase_2fmrac_5fconf_2eproto, "control_base/mrac_conf.proto", 409,
  &descriptor_table_control_5fbase_2fmrac_5fconf_2eproto_once, descriptor_table_control_5fbase_2fmrac_5fconf_2eproto_sccs, descriptor_table_control_5fbase_2fmrac_5fconf_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_control_5fbase_2fmrac_5fconf_2eproto::offsets,
  file_level_metadata_control_5fbase_2fmrac_5fconf_2eproto, 1, file_level_enum_descriptors_control_5fbase_2fmrac_5fconf_2eproto, file_level_service_descriptors_control_5fbase_2fmrac_5fconf_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_control_5fbase_2fmrac_5fconf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_control_5fbase_2fmrac_5fconf_2eproto)), true);
namespace control {
...
const MracConf& MracConf::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_MracConf_control_5fbase_2fmrac_5fconf_2eproto.base);
...
// @@protoc_insertion_point(generalized_merge_from_start:control.MracConf)
  GOOGLE_DCHECK_NE(&from, this);
  const MracConf* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MracConf>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:control.MracConf)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:control.MracConf)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:control.MracConf)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::control::MracConf* Arena::CreateMaybeMessage< ::control::MracConf >(Arena* arena) {
  return Arena::CreateMessageInternal< ::control::MracConf >(arena);
}
