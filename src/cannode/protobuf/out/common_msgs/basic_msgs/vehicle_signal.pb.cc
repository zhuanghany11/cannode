...
static void InitDefaultsscc_info_VehicleSignal_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::control::common::_VehicleSignal_default_instance_;
    new (ptr) ::control::common::VehicleSignal();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::control::common::VehicleSignal::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_VehicleSignal_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_VehicleSignal_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleSignal, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleSignal, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleSignal, turn_signal_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleSignal, high_beam_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleSignal, low_beam_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleSignal, horn_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleSignal, emergency_light_),
  0,
  1,
  2,
  3,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, sizeof(::control::common::VehicleSignal)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::control::common::_VehicleSignal_default_instance_),
};

const char descriptor_table_protodef_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto_sccs[1] = {
  &scc_info_VehicleSignal_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto = {
  false, false, descriptor_table_protodef_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto, "common_msgs/basic_msgs/vehicle_signal.proto", 278,
  &descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto_once, descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto_sccs, descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto::offsets,
  file_level_metadata_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto, 1, file_level_enum_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto, file_level_service_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto)), true);
namespace control {
namespace common {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* VehicleSignal_TurnSignal_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto);
...
VehicleSignal::VehicleSignal(const VehicleSignal& from)
  ...
  // @@protoc_insertion_point(copy_constructor:control.common.VehicleSignal)
}
...
const VehicleSignal& VehicleSignal::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_VehicleSignal_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::control::common::VehicleSignal_TurnSignal_IsValid(val))) {
            _internal_set_turn_signal(static_cast<::control::common::VehicleSignal_TurnSignal>(val));
          } else {
...
// @@protoc_insertion_point(generalized_merge_from_start:control.common.VehicleSignal)
  GOOGLE_DCHECK_NE(&from, this);
  const VehicleSignal* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<VehicleSignal>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:control.common.VehicleSignal)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:control.common.VehicleSignal)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:control.common.VehicleSignal)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::control::common::VehicleSignal* Arena::CreateMaybeMessage< ::control::common::VehicleSignal >(Arena* arena) {
  return Arena::CreateMessageInternal< ::control::common::VehicleSignal >(arena);
}
