...
#ifndef GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fdrive_5fstate_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fdrive_5fstate_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fdrive_5fstate_2eproto;
namespace control {
namespace common {
class EngageAdvice;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::common::EngageAdvice* Arena::CreateMaybeMessage<::control::common::EngageAdvice>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
namespace common {
...
class EngageAdvice PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.common.EngageAdvice) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.common.EngageAdvice";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fdrive_5fstate_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::control::common::EngageAdvice_Advice EngageAdvice::_internal_advice() const {
  return static_cast< ::control::common::EngageAdvice_Advice >(advice_);
}
...
inline void EngageAdvice::set_reason(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:control.common.EngageAdvice.reason)
}
inline void EngageAdvice::set_reason(const char* value) {
  ...
  reason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.common.EngageAdvice.reason)
}
inline void EngageAdvice::set_reason(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:control.common.EngageAdvice.reason)
}
...
inline std::string* EngageAdvice::unsafe_arena_release_reason() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.common.EngageAdvice.reason)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return reason_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void EngageAdvice::unsafe_arena_set_allocated_reason(
    std::string* reason) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (reason != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  reason_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      reason, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.common.EngageAdvice.reason)
}
...
template <> struct is_proto_enum< ::control::common::EngageAdvice_Advice> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fdrive_5fstate_2eproto
