...
#ifndef GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto;
namespace control {
namespace common {
class VehicleState;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::common::VehicleState* Arena::CreateMaybeMessage<::control::common::VehicleState>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
namespace common {
...
class VehicleState PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.common.VehicleState) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.common.VehicleState";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto);
    return ::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline const ::control::localization::Pose& VehicleState::pose() const {
...
inline ::control::localization::Pose* VehicleState::mutable_pose() {
  // @@protoc_insertion_point(field_mutable:control.common.VehicleState.pose)
  return _internal_mutable_pose();
}
inline void VehicleState::set_allocated_pose(::control::localization::Pose* pose) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto
