...
extern PROTOBUF_INTERNAL_EXPORT_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_StatusPb_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto;
namespace control {
namespace common {
...
static void InitDefaultsscc_info_Header_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::control::common::_Header_default_instance_;
    new (ptr) ::control::common::Header();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::control::common::Header::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Header_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Header_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto}, {
      &scc_info_StatusPb_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::control::common::Header, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::control::common::Header, timestamp_sec_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, module_name_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, sequence_num_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, lidar_timestamp_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, camera_timestamp_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, radar_timestamp_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, version_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, status_),
  PROTOBUF_FIELD_OFFSET(::control::common::Header, frame_id_),
  3,
  0,
  7,
  4,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 14, sizeof(::control::common::Header)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::control::common::_Header_default_instance_),
};

const char descriptor_table_protodef_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "d\030\t \001(\t"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto_deps[1] = {
  &::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto_sccs[1] = {
  &scc_info_Header_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto = {
  false, false, descriptor_table_protodef_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto, "common_msgs/basic_msgs/header.proto", 327,
  &descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto_once, descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto_sccs, descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto::offsets,
  file_level_metadata_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto, 1, file_level_enum_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto, file_level_service_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto)), true);
namespace control {
namespace common {
...
void Header::InitAsDefaultInstance() {
  ::control::common::_Header_default_instance_._instance.get_mutable()->status_ = const_cast< ::control::common::StatusPb*>(
      ::control::common::StatusPb::internal_default_instance());
}
class Header::_Internal {
 public:
  ...
  static const ::control::common::StatusPb& status(const Header* msg);
...
Header::Header(const Header& from)
  ...
  if (from._internal_has_module_name()) {
    module_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_module_name(),
      GetArena());
  }
  ...
  if (from._internal_has_status()) {
    status_ = new ::control::common::StatusPb(*from.status_);
  } else {
    status_ = nullptr;
  }
...
void Header::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Header_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto.base);
  module_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  frame_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "control.common.Header.module_name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 74)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "control.common.Header.frame_id");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(generalized_merge_from_start:control.common.Header)
  GOOGLE_DCHECK_NE(&from, this);
  const Header* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Header>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:control.common.Header)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:control.common.Header)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:control.common.Header)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _internal_mutable_status()->::control::common::StatusPb::MergeFrom(from._internal_status());
    }
    if (cached_has_bits & 0x00000008u) {
...
// @@protoc_insertion_point(generalized_copy_from_start:control.common.Header)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::control::common::Header* Arena::CreateMaybeMessage< ::control::common::Header >(Arena* arena) {
  return Arena::CreateMessageInternal< ::control::common::Header >(arena);
}
