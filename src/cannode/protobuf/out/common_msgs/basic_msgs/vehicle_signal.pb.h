...
#ifndef GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto;
namespace control {
namespace common {
class VehicleSignal;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::common::VehicleSignal* Arena::CreateMaybeMessage<::control::common::VehicleSignal>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
namespace common {
...
class VehicleSignal PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.common.VehicleSignal) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.common.VehicleSignal";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::control::common::VehicleSignal_TurnSignal VehicleSignal::_internal_turn_signal() const {
  return static_cast< ::control::common::VehicleSignal_TurnSignal >(turn_signal_);
}
...
template <> struct is_proto_enum< ::control::common::VehicleSignal_TurnSignal> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto
