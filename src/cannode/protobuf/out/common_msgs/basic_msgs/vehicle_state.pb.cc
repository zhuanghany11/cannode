...
static void InitDefaultsscc_info_VehicleState_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::control::common::_VehicleState_default_instance_;
    new (ptr) ::control::common::VehicleState();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::control::common::VehicleState::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_VehicleState_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_VehicleState_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto}, {
      &scc_info_Pose_localization_5fmsgs_2fpose_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, x_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, y_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, z_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, timestamp_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, roll_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, pitch_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, yaw_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, heading_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, kappa_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, linear_velocity_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, angular_velocity_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, linear_acceleration_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, gear_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, driving_mode_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, pose_),
  PROTOBUF_FIELD_OFFSET(::control::common::VehicleState, steering_percentage_),
  1,
  2,
  3,
  4,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 21, sizeof(::control::common::VehicleState)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::control::common::_VehicleState_default_instance_),
};

const char descriptor_table_protodef_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto_deps[2] = {
  &::descriptor_table_common_5fmsgs_2fchassis_5fmsgs_2fchassis_2eproto,
  &::descriptor_table_localization_5fmsgs_2fpose_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto_sccs[1] = {
  &scc_info_VehicleState_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto = {
  false, false, descriptor_table_protodef_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto, "common_msgs/basic_msgs/vehicle_state.proto", 571,
  &descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto_once, descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto_sccs, descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto_deps, 1, 2,
  schemas, file_default_instances, TableStruct_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto::offsets,
  file_level_metadata_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto, 1, file_level_enum_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto, file_level_service_descriptors_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto)), true);
namespace control {
namespace common {
...
void VehicleState::InitAsDefaultInstance() {
  ::control::common::_VehicleState_default_instance_._instance.get_mutable()->pose_ = const_cast< ::control::localization::Pose*>(
...
class VehicleState::_Internal {
 public:
  ...
  static const ::control::localization::Pose& pose(const VehicleState* msg);
...
void VehicleState::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_VehicleState_common_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fstate_2eproto.base);
...
// @@protoc_insertion_point(generalized_merge_from_start:control.common.VehicleState)
  GOOGLE_DCHECK_NE(&from, this);
  const VehicleState* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<VehicleState>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:control.common.VehicleState)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:control.common.VehicleState)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:control.common.VehicleState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::control::common::VehicleState* Arena::CreateMaybeMessage< ::control::common::VehicleState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::control::common::VehicleState >(arena);
}
