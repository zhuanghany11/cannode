...
#ifndef GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto;
namespace control {
namespace common {
class StatusPb;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::common::StatusPb* Arena::CreateMaybeMessage<::control::common::StatusPb>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
namespace common {
...
class StatusPb PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.common.StatusPb) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.common.StatusPb";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::control::common::ErrorCode StatusPb::_internal_error_code() const {
  return static_cast< ::control::common::ErrorCode >(error_code_);
}
...
inline void StatusPb::set_msg(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:control.common.StatusPb.msg)
}
inline void StatusPb::set_msg(const char* value) {
  ...
  msg_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.common.StatusPb.msg)
}
inline void StatusPb::set_msg(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:control.common.StatusPb.msg)
}
...
inline std::string* StatusPb::unsafe_arena_release_msg() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.common.StatusPb.msg)
...
inline void StatusPb::unsafe_arena_set_allocated_msg(
  ...
  msg_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      msg, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.common.StatusPb.msg)
}
...
template <> struct is_proto_enum< ::control::common::ErrorCode> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto
