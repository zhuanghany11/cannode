...
#ifndef GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto;
namespace control {
namespace common {
class Header;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::common::Header* Arena::CreateMaybeMessage<::control::common::Header>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
namespace common {
...
class Header PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.common.Header) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto);
    return ::descriptor_table_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  "    future release.")
  std::string* unsafe_arena_release_module_name();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
...
inline void Header::set_module_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:control.common.Header.module_name)
}
inline void Header::set_module_name(const char* value) {
  ...
  module_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.common.Header.module_name)
}
inline void Header::set_module_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:control.common.Header.module_name)
}
...
inline std::string* Header::unsafe_arena_release_module_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.common.Header.module_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return module_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Header::unsafe_arena_set_allocated_module_name(
    std::string* module_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (module_name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  module_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      module_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.common.Header.module_name)
}
...
inline const ::control::common::StatusPb& Header::_internal_status() const {
  const ::control::common::StatusPb* p = status_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::common::StatusPb*>(
      &::control::common::_StatusPb_default_instance_);
}
inline const ::control::common::StatusPb& Header::status() const {
...
inline ::control::common::StatusPb* Header::unsafe_arena_release_status() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  ::control::common::StatusPb* temp = status_;
  status_ = nullptr;
  return temp;
}
inline ::control::common::StatusPb* Header::_internal_mutable_status() {
  _has_bits_[0] |= 0x00000004u;
  if (status_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::common::StatusPb>(GetArena());
    status_ = p;
  }
  return status_;
}
inline ::control::common::StatusPb* Header::mutable_status() {
  // @@protoc_insertion_point(field_mutable:control.common.Header.status)
  return _internal_mutable_status();
}
inline void Header::set_allocated_status(::control::common::StatusPb* status) {
...
inline void Header::set_frame_id(std::string&& value) {
  ...
  frame_id_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:control.common.Header.frame_id)
}
inline void Header::set_frame_id(const char* value) {
  ...
  frame_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.common.Header.frame_id)
}
inline void Header::set_frame_id(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  frame_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:control.common.Header.frame_id)
}
...
inline std::string* Header::unsafe_arena_release_frame_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.common.Header.frame_id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
...
inline void Header::unsafe_arena_set_allocated_frame_id(
  ...
  frame_id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      frame_id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.common.Header.frame_id)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_common_5fmsgs_2fbasic_5fmsgs_2fheader_2eproto
