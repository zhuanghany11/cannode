...
#ifndef GOOGLE_PROTOBUF_INCLUDED_external_5fcommand_5fmsgs_2flane_5fsegment_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_external_5fcommand_5fmsgs_2flane_5fsegment_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_external_5fcommand_5fmsgs_2flane_5fsegment_2eproto;
namespace control {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::external_command::LaneSegment* Arena::CreateMaybeMessage<::control::external_command::LaneSegment>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
namespace external_command {
...
class LaneSegment PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.external_command.LaneSegment) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.external_command.LaneSegment";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_external_5fcommand_5fmsgs_2flane_5fsegment_2eproto);
    return ::descriptor_table_external_5fcommand_5fmsgs_2flane_5fsegment_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void LaneSegment::set_id(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:control.external_command.LaneSegment.id)
}
inline void LaneSegment::set_id(const char* value) {
  ...
  id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.external_command.LaneSegment.id)
}
inline void LaneSegment::set_id(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:control.external_command.LaneSegment.id)
}
...
inline std::string* LaneSegment::unsafe_arena_release_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.external_command.LaneSegment.id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LaneSegment::unsafe_arena_set_allocated_id(
    std::string* id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (id != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.external_command.LaneSegment.id)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_external_5fcommand_5fmsgs_2flane_5fsegment_2eproto
