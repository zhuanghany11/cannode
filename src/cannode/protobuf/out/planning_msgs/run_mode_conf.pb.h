...
#ifndef GOOGLE_PROTOBUF_INCLUDED_planning_5fmsgs_2frun_5fmode_5fconf_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_planning_5fmsgs_2frun_5fmode_5fconf_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_planning_5fmsgs_2frun_5fmode_5fconf_2eproto;
namespace control {
class RunModeConf;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::RunModeConf* Arena::CreateMaybeMessage<::control::RunModeConf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
...
class RunModeConf PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.RunModeConf) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_planning_5fmsgs_2frun_5fmode_5fconf_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::control::RunMode RunModeConf::_internal_run_mode() const {
  return static_cast< ::control::RunMode >(run_mode_);
}
...
inline ::control::ClockMode RunModeConf::_internal_clock_mode() const {
  return static_cast< ::control::ClockMode >(clock_mode_);
}
...
template <> struct is_proto_enum< ::control::RunMode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::control::RunMode>() {
  return ::control::RunMode_descriptor();
}
template <> struct is_proto_enum< ::control::ClockMode> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_planning_5fmsgs_2frun_5fmode_5fconf_2eproto
