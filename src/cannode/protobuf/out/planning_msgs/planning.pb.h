...
#ifndef GOOGLE_PROTOBUF_INCLUDED_planning_5fmsgs_2fplanning_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_planning_5fmsgs_2fplanning_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_planning_5fmsgs_2fplanning_2eproto;
namespace control {
namespace planning {
class ADCTrajectory;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::control::planning::ADCTrajectory* Arena::CreateMaybeMessage<::control::planning::ADCTrajectory>(Arena*);
template<> ::control::planning::ADCTrajectory_CriticalRegion* Arena::CreateMaybeMessage<::control::planning::ADCTrajectory_CriticalRegion>(Arena*);
template<> ::control::planning::EStop* Arena::CreateMaybeMessage<::control::planning::EStop>(Arena*);
template<> ::control::planning::LatencyStats* Arena::CreateMaybeMessage<::control::planning::LatencyStats>(Arena*);
template<> ::control::planning::RSSInfo* Arena::CreateMaybeMessage<::control::planning::RSSInfo>(Arena*);
template<> ::control::planning::TaskStats* Arena::CreateMaybeMessage<::control::planning::TaskStats>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace control {
namespace planning {
...
constexpr ADCTrajectory_TrajectoryType ADCTrajectory_TrajectoryType_TrajectoryType_MAX = ADCTrajectory_TrajectoryType_OPEN_SPACE;
...
class EStop PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.planning.EStop) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_planning_5fmsgs_2fplanning_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class TaskStats PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.planning.TaskStats) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.planning.TaskStats";
  }
  protected:
...
class LatencyStats PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.planning.LatencyStats) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.planning.LatencyStats";
  }
  protected:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::planning::TaskStats >*
      mutable_task_stats();
  private:
  const ::control::planning::TaskStats& _internal_task_stats(int index) const;
  ::control::planning::TaskStats* _internal_add_task_stats();
  public:
  const ::control::planning::TaskStats& task_stats(int index) const;
  ::control::planning::TaskStats* add_task_stats();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::planning::TaskStats >&
      task_stats() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::planning::TaskStats > task_stats_;
...
class RSSInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.planning.RSSInfo) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.planning.RSSInfo";
  }
  protected:
...
class ADCTrajectory_CriticalRegion PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.planning.ADCTrajectory.CriticalRegion) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.planning.ADCTrajectory.CriticalRegion";
  }
  protected:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::Polygon >*
      mutable_region();
  private:
  const ::control::common::Polygon& _internal_region(int index) const;
  ::control::common::Polygon* _internal_add_region();
  public:
  const ::control::common::Polygon& region(int index) const;
  ::control::common::Polygon* add_region();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::Polygon >&
      region() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::Polygon > region_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_planning_5fmsgs_2fplanning_2eproto;
};
// -------------------------------------------------------------------
...
class ADCTrajectory PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:control.planning.ADCTrajectory) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "control.planning.ADCTrajectory";
  }
  protected:
  ...
  static constexpr TrajectoryType OPEN_SPACE =
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::PointLLH >*
      mutable_point_llh();
  private:
  const ::control::common::PointLLH& _internal_point_llh(int index) const;
  ::control::common::PointLLH* _internal_add_point_llh();
  public:
  const ::control::common::PointLLH& point_llh(int index) const;
  ::control::common::PointLLH* add_point_llh();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::PointLLH >&
      point_llh() const;
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_replan_reason();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_replan_reason(
  ...
  ::control::planning::EStop* release_estop();
  ::control::planning::EStop* mutable_estop();
  void set_allocated_estop(::control::planning::EStop* estop);
  private:
  ...
  ::control::planning_internal::Debug* release_debug();
  ::control::planning_internal::Debug* mutable_debug();
  void set_allocated_debug(::control::planning_internal::Debug* debug);
  private:
  ...
  void unsafe_arena_set_allocated_debug(
      ::control::planning_internal::Debug* debug);
  ...
  ::control::planning::DecisionResult* release_decision();
  ::control::planning::DecisionResult* mutable_decision();
  void set_allocated_decision(::control::planning::DecisionResult* decision);
  private:
  ...
  void unsafe_arena_set_allocated_decision(
      ::control::planning::DecisionResult* decision);
  ...
  ::control::planning::LatencyStats* release_latency_stats();
  ::control::planning::LatencyStats* mutable_latency_stats();
  void set_allocated_latency_stats(::control::planning::LatencyStats* latency_stats);
  private:
  ...
  void unsafe_arena_set_allocated_latency_stats(
      ::control::planning::LatencyStats* latency_stats);
  ...
  ::control::common::Header* release_routing_header();
  ::control::common::Header* mutable_routing_header();
  void set_allocated_routing_header(::control::common::Header* routing_header);
  private:
  ...
  void unsafe_arena_set_allocated_routing_header(
      ::control::common::Header* routing_header);
  ...
  ::control::planning::ADCTrajectory_CriticalRegion* release_critical_region();
  ::control::planning::ADCTrajectory_CriticalRegion* mutable_critical_region();
  void set_allocated_critical_region(::control::planning::ADCTrajectory_CriticalRegion* critical_region);
  private:
  ...
  void unsafe_arena_set_allocated_critical_region(
      ::control::planning::ADCTrajectory_CriticalRegion* critical_region);
  ...
  ::control::planning::RSSInfo* release_rss_info();
  ::control::planning::RSSInfo* mutable_rss_info();
  void set_allocated_rss_info(::control::planning::RSSInfo* rss_info);
  private:
  ...
  void unsafe_arena_set_allocated_rss_info(
      ::control::planning::RSSInfo* rss_info);
  ...
  private:
  bool _internal_has_align_guide_loc() const;
  public:
  ...
  private:
  bool _internal_has_lift_weight() const;
  public:
  void clear_lift_weight();
  ::PROTOBUF_NAMESPACE_ID::int32 lift_weight() const;
  void set_lift_weight(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_lift_weight() const;
  void _internal_set_lift_weight(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // optional int32 opendoor_status = 28;
  bool has_opendoor_status() const;
  private:
  bool _internal_has_opendoor_status() const;
  public:
  void clear_opendoor_status();
  ::PROTOBUF_NAMESPACE_ID::int32 opendoor_status() const;
  void set_opendoor_status(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_opendoor_status() const;
  void _internal_set_opendoor_status(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // optional uint32 pto = 29;
  bool has_pto() const;
  private:
  bool _internal_has_pto() const;
  public:
  void clear_pto();
  ::PROTOBUF_NAMESPACE_ID::uint32 pto() const;
  void set_pto(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_pto() const;
  void _internal_set_pto(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:

  // optional int32 plan_state = 30;
  bool has_plan_state() const;
  private:
  bool _internal_has_plan_state() const;
  public:
  void clear_plan_state();
  ::PROTOBUF_NAMESPACE_ID::int32 plan_state() const;
  void set_plan_state(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_plan_state() const;
  void _internal_set_plan_state(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::PointLLH > point_llh_;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 lift_weight_;
  ::PROTOBUF_NAMESPACE_ID::int32 opendoor_status_;
  ::PROTOBUF_NAMESPACE_ID::uint32 pto_;
  ::PROTOBUF_NAMESPACE_ID::int32 plan_state_;
  friend struct ::TableStruct_planning_5fmsgs_2fplanning_2eproto;
};
// ===================================================================
...
inline void EStop::set_reason(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:control.planning.EStop.reason)
}
inline void EStop::set_reason(const char* value) {
  ...
  reason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.planning.EStop.reason)
}
inline void EStop::set_reason(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:control.planning.EStop.reason)
}
...
inline std::string* EStop::unsafe_arena_release_reason() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.planning.EStop.reason)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return reason_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void EStop::unsafe_arena_set_allocated_reason(
    std::string* reason) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (reason != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  reason_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      reason, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.planning.EStop.reason)
}
...
inline void TaskStats::set_name(std::string&& value) {
  ...
  name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:control.planning.TaskStats.name)
}
inline void TaskStats::set_name(const char* value) {
  ...
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.planning.TaskStats.name)
}
inline void TaskStats::set_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:control.planning.TaskStats.name)
}
...
inline std::string* TaskStats::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.planning.TaskStats.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TaskStats::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.planning.TaskStats.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::planning::TaskStats >*
LatencyStats::mutable_task_stats() {
  // @@protoc_insertion_point(field_mutable_list:control.planning.LatencyStats.task_stats)
  return &task_stats_;
}
inline const ::control::planning::TaskStats& LatencyStats::_internal_task_stats(int index) const {
...
inline ::control::planning::TaskStats* LatencyStats::_internal_add_task_stats() {
  return task_stats_.Add();
}
inline ::control::planning::TaskStats* LatencyStats::add_task_stats() {
  // @@protoc_insertion_point(field_add:control.planning.LatencyStats.task_stats)
  return _internal_add_task_stats();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::planning::TaskStats >&
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::Polygon >*
...
inline const ::control::common::Polygon& ADCTrajectory_CriticalRegion::_internal_region(int index) const {
...
inline ::control::common::Polygon* ADCTrajectory_CriticalRegion::_internal_add_region() {
  return region_.Add();
}
inline ::control::common::Polygon* ADCTrajectory_CriticalRegion::add_region() {
  // @@protoc_insertion_point(field_add:control.planning.ADCTrajectory.CriticalRegion.region)
  return _internal_add_region();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::Polygon >&
...
inline const ::control::common::Header& ADCTrajectory::header() const {
...
inline ::control::common::Header* ADCTrajectory::mutable_header() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.header)
  return _internal_mutable_header();
}
inline void ADCTrajectory::set_allocated_header(::control::common::Header* header) {
...
// optional double reference_speed = 4;
inline bool ADCTrajectory::_internal_has_reference_speed() const {
...
// optional double map_speed_limit = 5;
inline bool ADCTrajectory::_internal_has_map_speed_limit() const {
...
inline const ::control::planning::EStop& ADCTrajectory::_internal_estop() const {
  const ::control::planning::EStop* p = estop_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::planning::EStop*>(
      &::control::planning::_EStop_default_instance_);
}
inline const ::control::planning::EStop& ADCTrajectory::estop() const {
...
inline ::control::planning::EStop* ADCTrajectory::release_estop() {
  auto temp = unsafe_arena_release_estop();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::control::planning::EStop* ADCTrajectory::unsafe_arena_release_estop() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  ::control::planning::EStop* temp = estop_;
  estop_ = nullptr;
  return temp;
}
inline ::control::planning::EStop* ADCTrajectory::_internal_mutable_estop() {
  _has_bits_[0] |= 0x00000004u;
  if (estop_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::planning::EStop>(GetArena());
    estop_ = p;
  }
  return estop_;
}
inline ::control::planning::EStop* ADCTrajectory::mutable_estop() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.estop)
  return _internal_mutable_estop();
}
inline void ADCTrajectory::set_allocated_estop(::control::planning::EStop* estop) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete estop_;
  }
...
inline const ::control::planning_internal::Debug& ADCTrajectory::_internal_debug() const {
  const ::control::planning_internal::Debug* p = debug_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::planning_internal::Debug*>(
      &::control::planning_internal::_Debug_default_instance_);
}
inline const ::control::planning_internal::Debug& ADCTrajectory::debug() const {
...
inline ::control::planning_internal::Debug* ADCTrajectory::unsafe_arena_release_debug() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  ::control::planning_internal::Debug* temp = debug_;
  debug_ = nullptr;
  return temp;
}
inline ::control::planning_internal::Debug* ADCTrajectory::_internal_mutable_debug() {
  _has_bits_[0] |= 0x00000008u;
  if (debug_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::planning_internal::Debug>(GetArena());
    debug_ = p;
  }
  return debug_;
}
inline ::control::planning_internal::Debug* ADCTrajectory::mutable_debug() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.debug)
  return _internal_mutable_debug();
}
inline void ADCTrajectory::set_allocated_debug(::control::planning_internal::Debug* debug) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(debug_);
  }
...
inline ::control::canbus::Chassis_GearPosition ADCTrajectory::_internal_gear() const {
  return static_cast< ::control::canbus::Chassis_GearPosition >(gear_);
}
...
inline const ::control::common::TrajectoryPoint& ADCTrajectory::_internal_trajectory_point(int index) const {
...
inline ::control::common::TrajectoryPoint* ADCTrajectory::_internal_add_trajectory_point() {
  return trajectory_point_.Add();
}
inline ::control::common::TrajectoryPoint* ADCTrajectory::add_trajectory_point() {
...
inline const ::control::common::PathPoint& ADCTrajectory::_internal_path_point(int index) const {
...
inline ::control::common::PathPoint* ADCTrajectory::_internal_add_path_point() {
  return path_point_.Add();
}
inline ::control::common::PathPoint* ADCTrajectory::add_path_point() {
...
inline const ::control::planning::DecisionResult& ADCTrajectory::_internal_decision() const {
  const ::control::planning::DecisionResult* p = decision_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::planning::DecisionResult*>(
      &::control::planning::_DecisionResult_default_instance_);
}
inline const ::control::planning::DecisionResult& ADCTrajectory::decision() const {
...
inline ::control::planning::DecisionResult* ADCTrajectory::unsafe_arena_release_decision() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  ::control::planning::DecisionResult* temp = decision_;
  decision_ = nullptr;
  return temp;
}
inline ::control::planning::DecisionResult* ADCTrajectory::_internal_mutable_decision() {
  ...
  if (decision_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::planning::DecisionResult>(GetArena());
    decision_ = p;
  }
  return decision_;
}
inline ::control::planning::DecisionResult* ADCTrajectory::mutable_decision() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.decision)
  return _internal_mutable_decision();
}
inline void ADCTrajectory::set_allocated_decision(::control::planning::DecisionResult* decision) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(decision_);
  }
...
inline const ::control::planning::LatencyStats& ADCTrajectory::_internal_latency_stats() const {
  const ::control::planning::LatencyStats* p = latency_stats_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::planning::LatencyStats*>(
      &::control::planning::_LatencyStats_default_instance_);
}
inline const ::control::planning::LatencyStats& ADCTrajectory::latency_stats() const {
...
inline ::control::planning::LatencyStats* ADCTrajectory::unsafe_arena_release_latency_stats() {
  ...
  _has_bits_[0] &= ~0x00000020u;
  ::control::planning::LatencyStats* temp = latency_stats_;
...
inline ::control::planning::LatencyStats* ADCTrajectory::_internal_mutable_latency_stats() {
  ...
  if (latency_stats_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::planning::LatencyStats>(GetArena());
    latency_stats_ = p;
  }
  return latency_stats_;
}
inline ::control::planning::LatencyStats* ADCTrajectory::mutable_latency_stats() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.latency_stats)
  return _internal_mutable_latency_stats();
}
inline void ADCTrajectory::set_allocated_latency_stats(::control::planning::LatencyStats* latency_stats) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
...
inline const ::control::common::Header& ADCTrajectory::_internal_routing_header() const {
  const ::control::common::Header* p = routing_header_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::common::Header*>(
      &::control::common::_Header_default_instance_);
}
inline const ::control::common::Header& ADCTrajectory::routing_header() const {
...
inline ::control::common::Header* ADCTrajectory::release_routing_header() {
  auto temp = unsafe_arena_release_routing_header();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::control::common::Header* ADCTrajectory::unsafe_arena_release_routing_header() {
  ...
  _has_bits_[0] &= ~0x00000040u;
  ::control::common::Header* temp = routing_header_;
...
inline ::control::common::Header* ADCTrajectory::mutable_routing_header() {
...
inline void ADCTrajectory::set_allocated_routing_header(::control::common::Header* routing_header) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(routing_header_);
  }
...
inline ::control::planning::ADCTrajectory_RightOfWayStatus ADCTrajectory::_internal_right_of_way_status() const {
  return static_cast< ::control::planning::ADCTrajectory_RightOfWayStatus >(right_of_way_status_);
}
...
inline const ::control::common::EngageAdvice& ADCTrajectory::engage_advice() const {
...
inline ::control::common::EngageAdvice* ADCTrajectory::mutable_engage_advice() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.engage_advice)
  return _internal_mutable_engage_advice();
}
inline void ADCTrajectory::set_allocated_engage_advice(::control::common::EngageAdvice* engage_advice) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(engage_advice_);
  }
...
inline const ::control::planning::ADCTrajectory_CriticalRegion& ADCTrajectory::_internal_critical_region() const {
  const ::control::planning::ADCTrajectory_CriticalRegion* p = critical_region_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::planning::ADCTrajectory_CriticalRegion*>(
      &::control::planning::_ADCTrajectory_CriticalRegion_default_instance_);
}
inline const ::control::planning::ADCTrajectory_CriticalRegion& ADCTrajectory::critical_region() const {
...
inline ::control::planning::ADCTrajectory_CriticalRegion* ADCTrajectory::release_critical_region() {
  auto temp = unsafe_arena_release_critical_region();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::control::planning::ADCTrajectory_CriticalRegion* ADCTrajectory::unsafe_arena_release_critical_region() {
  ...
  _has_bits_[0] &= ~0x00000100u;
  ::control::planning::ADCTrajectory_CriticalRegion* temp = critical_region_;
...
inline ::control::planning::ADCTrajectory_CriticalRegion* ADCTrajectory::_internal_mutable_critical_region() {
  ...
  if (critical_region_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::planning::ADCTrajectory_CriticalRegion>(GetArena());
    critical_region_ = p;
  }
  return critical_region_;
}
inline ::control::planning::ADCTrajectory_CriticalRegion* ADCTrajectory::mutable_critical_region() {
...
inline void ADCTrajectory::set_allocated_critical_region(::control::planning::ADCTrajectory_CriticalRegion* critical_region) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
...
inline ::control::planning::ADCTrajectory_TrajectoryType ADCTrajectory::_internal_trajectory_type() const {
  return static_cast< ::control::planning::ADCTrajectory_TrajectoryType >(trajectory_type_);
}
...
inline void ADCTrajectory::clear_replan_reason() {
  replan_reason_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void ADCTrajectory::_internal_set_replan_reason(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  replan_reason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void ADCTrajectory::set_replan_reason(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  replan_reason_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:control.planning.ADCTrajectory.replan_reason)
}
inline void ADCTrajectory::set_replan_reason(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  replan_reason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:control.planning.ADCTrajectory.replan_reason)
}
inline void ADCTrajectory::set_replan_reason(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  replan_reason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:control.planning.ADCTrajectory.replan_reason)
}
inline std::string* ADCTrajectory::_internal_mutable_replan_reason() {
  _has_bits_[0] |= 0x00000001u;
  return replan_reason_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* ADCTrajectory::unsafe_arena_release_replan_reason() {
  // @@protoc_insertion_point(field_unsafe_arena_release:control.planning.ADCTrajectory.replan_reason)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return replan_reason_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ADCTrajectory::unsafe_arena_set_allocated_replan_reason(
    std::string* replan_reason) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (replan_reason != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  replan_reason_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      replan_reason, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:control.planning.ADCTrajectory.replan_reason)
}
...
inline ::control::common::PointLLH* ADCTrajectory::mutable_point_llh(int index) {
  ...
  return point_llh_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::PointLLH >*
ADCTrajectory::mutable_point_llh() {
  // @@protoc_insertion_point(field_mutable_list:control.planning.ADCTrajectory.point_llh)
  return &point_llh_;
}
inline const ::control::common::PointLLH& ADCTrajectory::_internal_point_llh(int index) const {
  return point_llh_.Get(index);
}
inline const ::control::common::PointLLH& ADCTrajectory::point_llh(int index) const {
  ...
  return _internal_point_llh(index);
}
inline ::control::common::PointLLH* ADCTrajectory::_internal_add_point_llh() {
  return point_llh_.Add();
}
inline ::control::common::PointLLH* ADCTrajectory::add_point_llh() {
  // @@protoc_insertion_point(field_add:control.planning.ADCTrajectory.point_llh)
  return _internal_add_point_llh();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::control::common::PointLLH >&
ADCTrajectory::point_llh() const {
  // @@protoc_insertion_point(field_list:control.planning.ADCTrajectory.point_llh)
  return point_llh_;
}

// optional int32 lift_weight = 26;
inline bool ADCTrajectory::_internal_has_lift_weight() const {
  bool value = (_has_bits_[0] & 0x00200000u) != 0;
  return value;
}
inline bool ADCTrajectory::has_lift_weight() const {
  return _internal_has_lift_weight();
}
inline void ADCTrajectory::clear_lift_weight() {
  lift_weight_ = 0;
  _has_bits_[0] &= ~0x00200000u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ADCTrajectory::_internal_lift_weight() const {
  return lift_weight_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ADCTrajectory::lift_weight() const {
  // @@protoc_insertion_point(field_get:control.planning.ADCTrajectory.lift_weight)
  return _internal_lift_weight();
}
inline void ADCTrajectory::_internal_set_lift_weight(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00200000u;
  lift_weight_ = value;
}
inline void ADCTrajectory::set_lift_weight(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_lift_weight(value);
  // @@protoc_insertion_point(field_set:control.planning.ADCTrajectory.lift_weight)
}

// optional double align_guide_loc = 27;
inline bool ADCTrajectory::_internal_has_align_guide_loc() const {
  bool value = (_has_bits_[0] & 0x00100000u) != 0;
  return value;
}
inline bool ADCTrajectory::has_align_guide_loc() const {
  return _internal_has_align_guide_loc();
}
...
// optional int32 opendoor_status = 28;
inline bool ADCTrajectory::_internal_has_opendoor_status() const {
  bool value = (_has_bits_[0] & 0x00400000u) != 0;
  return value;
}
inline bool ADCTrajectory::has_opendoor_status() const {
  return _internal_has_opendoor_status();
}
inline void ADCTrajectory::clear_opendoor_status() {
  opendoor_status_ = 0;
  _has_bits_[0] &= ~0x00400000u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ADCTrajectory::_internal_opendoor_status() const {
  return opendoor_status_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ADCTrajectory::opendoor_status() const {
  // @@protoc_insertion_point(field_get:control.planning.ADCTrajectory.opendoor_status)
  return _internal_opendoor_status();
}
inline void ADCTrajectory::_internal_set_opendoor_status(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00400000u;
  opendoor_status_ = value;
}
inline void ADCTrajectory::set_opendoor_status(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_opendoor_status(value);
  // @@protoc_insertion_point(field_set:control.planning.ADCTrajectory.opendoor_status)
}

// optional uint32 pto = 29;
inline bool ADCTrajectory::_internal_has_pto() const {
  bool value = (_has_bits_[0] & 0x00800000u) != 0;
  return value;
}
inline bool ADCTrajectory::has_pto() const {
  return _internal_has_pto();
}
inline void ADCTrajectory::clear_pto() {
  pto_ = 0u;
  _has_bits_[0] &= ~0x00800000u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 ADCTrajectory::_internal_pto() const {
  return pto_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 ADCTrajectory::pto() const {
  // @@protoc_insertion_point(field_get:control.planning.ADCTrajectory.pto)
  return _internal_pto();
}
inline void ADCTrajectory::_internal_set_pto(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00800000u;
  pto_ = value;
}
inline void ADCTrajectory::set_pto(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_pto(value);
  // @@protoc_insertion_point(field_set:control.planning.ADCTrajectory.pto)
}

// optional int32 plan_state = 30;
inline bool ADCTrajectory::_internal_has_plan_state() const {
  bool value = (_has_bits_[0] & 0x01000000u) != 0;
  return value;
}
inline bool ADCTrajectory::has_plan_state() const {
  return _internal_has_plan_state();
}
inline void ADCTrajectory::clear_plan_state() {
  plan_state_ = 0;
  _has_bits_[0] &= ~0x01000000u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ADCTrajectory::_internal_plan_state() const {
  return plan_state_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ADCTrajectory::plan_state() const {
  // @@protoc_insertion_point(field_get:control.planning.ADCTrajectory.plan_state)
  return _internal_plan_state();
}
inline void ADCTrajectory::_internal_set_plan_state(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x01000000u;
  plan_state_ = value;
}
inline void ADCTrajectory::set_plan_state(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_plan_state(value);
  // @@protoc_insertion_point(field_set:control.planning.ADCTrajectory.plan_state)
}

// optional .control.canbus.JointAngle joint_angle = 31;
inline bool ADCTrajectory::_internal_has_joint_angle() const {
  bool value = (_has_bits_[0] & 0x00000200u) != 0;
  PROTOBUF_ASSUME(!value || joint_angle_ != nullptr);
  return value;
}
inline bool ADCTrajectory::has_joint_angle() const {
  return _internal_has_joint_angle();
}
inline const ::control::canbus::JointAngle& ADCTrajectory::_internal_joint_angle() const {
  const ::control::canbus::JointAngle* p = joint_angle_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::canbus::JointAngle*>(
      &::control::canbus::_JointAngle_default_instance_);
}
inline const ::control::canbus::JointAngle& ADCTrajectory::joint_angle() const {
  // @@protoc_insertion_point(field_get:control.planning.ADCTrajectory.joint_angle)
  return _internal_joint_angle();
}
inline void ADCTrajectory::unsafe_arena_set_allocated_joint_angle(
    ::control::canbus::JointAngle* joint_angle) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(joint_angle_);
  }
...
inline ::control::canbus::JointAngle* ADCTrajectory::release_joint_angle() {
  auto temp = unsafe_arena_release_joint_angle();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::control::canbus::JointAngle* ADCTrajectory::unsafe_arena_release_joint_angle() {
  ...
  _has_bits_[0] &= ~0x00000200u;
  ::control::canbus::JointAngle* temp = joint_angle_;
  joint_angle_ = nullptr;
  return temp;
}
inline ::control::canbus::JointAngle* ADCTrajectory::_internal_mutable_joint_angle() {
  _has_bits_[0] |= 0x00000200u;
  if (joint_angle_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::canbus::JointAngle>(GetArena());
    joint_angle_ = p;
  }
  return joint_angle_;
}
inline ::control::canbus::JointAngle* ADCTrajectory::mutable_joint_angle() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.joint_angle)
  return _internal_mutable_joint_angle();
}
inline void ADCTrajectory::set_allocated_joint_angle(::control::canbus::JointAngle* joint_angle) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(joint_angle_);
  }
  if (joint_angle) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(joint_angle)->GetArena();
    if (message_arena != submessage_arena) {
      joint_angle = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, joint_angle, submessage_arena);
    }
    _has_bits_[0] |= 0x00000200u;
  } else {
    _has_bits_[0] &= ~0x00000200u;
...
inline const ::control::planning::RSSInfo& ADCTrajectory::_internal_rss_info() const {
  const ::control::planning::RSSInfo* p = rss_info_;
  return p != nullptr ? *p : *reinterpret_cast<const ::control::planning::RSSInfo*>(
      &::control::planning::_RSSInfo_default_instance_);
}
inline const ::control::planning::RSSInfo& ADCTrajectory::rss_info() const {
...
inline ::control::planning::RSSInfo* ADCTrajectory::release_rss_info() {
  auto temp = unsafe_arena_release_rss_info();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::control::planning::RSSInfo* ADCTrajectory::unsafe_arena_release_rss_info() {
  ...
  _has_bits_[0] &= ~0x00000400u;
  ::control::planning::RSSInfo* temp = rss_info_;
  rss_info_ = nullptr;
  return temp;
}
inline ::control::planning::RSSInfo* ADCTrajectory::_internal_mutable_rss_info() {
  ...
  if (rss_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::control::planning::RSSInfo>(GetArena());
    rss_info_ = p;
  }
  return rss_info_;
}
inline ::control::planning::RSSInfo* ADCTrajectory::mutable_rss_info() {
  // @@protoc_insertion_point(field_mutable:control.planning.ADCTrajectory.rss_info)
  return _internal_mutable_rss_info();
}
inline void ADCTrajectory::set_allocated_rss_info(::control::planning::RSSInfo* rss_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete rss_info_;
  }
...
template <> struct is_proto_enum< ::control::planning::ADCTrajectory_RightOfWayStatus> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::control::planning::ADCTrajectory_TrajectoryType> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::control::planning::JucType> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_planning_5fmsgs_2fplanning_2eproto
